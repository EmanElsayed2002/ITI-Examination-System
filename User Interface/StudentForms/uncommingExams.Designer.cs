namespace User_Interface.StudentForms
{
    partial class uncommingExams
    {
        ...
        {
            dataGridIuncommingExams = new DataGridView();
            panel1 = new Panel();
            button1 = new Button();
            button7 = new Button();
            button5 = new Button();
            ...
            button3 = new Button();
            button2 = new Button();
            ((System.ComponentModel.ISupportInitialize)dataGridIuncommingExams).BeginInit();
            panel1.SuspendLayout();
            SuspendLayout();
            // 
            // dataGridIuncommingExams
            // 
            dataGridIuncommingExams.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dataGridIuncommingExams.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridIuncommingExams.Location = new Point(0, 0);
            dataGridIuncommingExams.Name = "dataGridIuncommingExams";
            dataGridIuncommingExams.RowHeadersWidth = 51;
            dataGridIuncommingExams.Size = new Size(1358, 619);
            dataGridIuncommingExams.TabIndex = 0;
            // 
            // panel1
            // 
            panel1.BackColor = Color.PaleGreen;
            panel1.Controls.Add(dataGridIuncommingExams);
            ...
            Name = "uncommingExams";
            Text = "uncommingExams";
            Load += uncommingExams_Load;
            ((System.ComponentModel.ISupportInitialize)dataGridIuncommingExams).EndInit();
        ...
        private DataGridView dataGridIuncommingExams;
