namespace User_Interface.StudentForms
{
    partial class EnterExam
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel1.Controls.Add(boxtext);
            panel1.Controls.Add(currExams);
            ...
            button8.Location = new Point(654, 510);
            button8.Name = "button8";
            button8.Size = new Size(174, 63);
            button8.TabIndex = 3;
            button8.Text = "start";
            ...
            // boxtext
            // 
            boxtext.BackColor = Color.PaleGreen;
            boxtext.BorderStyle = BorderStyle.None;
            boxtext.Font = new Font("Segoe UI", 10.2F, FontStyle.Bold, GraphicsUnit.Point, 0);
            boxtext.Location = new Point(274, 155);
            boxtext.Multiline = true;
            boxtext.Name = "boxtext";
            boxtext.ReadOnly = true;
            boxtext.Size = new Size(1005, 349);
            boxtext.TabIndex = 2;
            boxtext.Text = resources.GetString("boxtext.Text");
            boxtext.TextChanged += textBox1_TextChanged;
            // 
            // currExams
            // 
            currExams.DropDownStyle = ComboBoxStyle.DropDownList;
            currExams.FormattingEnabled = true;
            currExams.Location = new Point(550, 44);
            currExams.Name = "currExams";
            currExams.Size = new Size(402, 28);
            currExams.TabIndex = 1;
            currExams.SelectedIndexChanged += currExams_SelectedIndexChanged;
            // 
            // label1
            // 
            ...
            label1.TabIndex = 0;
            label1.Text = "Choose Exam you want to start";
            // 
            // button5
            // 
