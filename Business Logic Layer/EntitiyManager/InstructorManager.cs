...
namespace Business_Logic_Layer.EntityManager
{
    public class InstructorManager
    {
        ...
        public static void SyncInstructorData(DataTable dt)
        {
            SqlDataAdapter adapter = Data_Access_Layer.DBManager.AdminGetDataAdapter(dt);
        ...
        public static void SyncStudentData(DataTable dt)
        {
            SqlDataAdapter adapter = Data_Access_Layer.DBManager.AdminSyncStudentGetDataAdapter(dt);
